...
namespace Vaquinha.Unit.Tests.DomainTests
{
    ...
    public class CausaTests: IClassFixture<CausaFixture>
    {
        ...
        public void Causa_CausaCamposMaxLength_CausaInvalida()
        {
            ...
            causa.ErrorMessages.Should().HaveCount(3, because: "o preenchimento de 3 campos ultrapassou o tamanho máximo permitido.");

            causa.ErrorMessages.Should().Contain("O campo Nome deve possuir no máximo 250 caracteres.", because: "o campo Nome ultrapassou o tamanho máximo permitido.");
            causa.ErrorMessages.Should().Contain("O campo Cidade deve possuir no máximo 250 caracteres.", because: "o campo Cidade ultrapassou o tamanho máximo permitido.");
            causa.ErrorMessages.Should().Contain("O campo Estado deve possuir no máximo 250 caracteres.", because: "o campo Estado ultrapassou tamanho máximo permitido.");
        }
